package com.distribuidas.dao.ramiro;
...
public class ProveedorDAO {
    ...
    public ObservableList<Proveedor> getAll() {
        ...
        // Query specific to Ramiro (Quito) fragment
        String sql = "SELECT * FROM FRAGMENTO_PROVEEDOR_QUITO@dblink_spinta ORDER BY PROVEEDORID";
